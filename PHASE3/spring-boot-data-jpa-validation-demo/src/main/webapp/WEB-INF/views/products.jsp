...
<script>
	function showEditForm(id, name, price) {
		...
		// Scroll to form
		window.scrollTo(0,
				document.getElementById("edit-form-container").offsetTop);
	}
</script>
...
<body>
	...
	<div id="edit-form-container" style="display: none;">
		...
		<form action="edit-product" method="POST">
			<input type="hidden" id="edit-id" name="id"> NAME: <input
				id="edit-name" name="name"> PRICE: <input id="edit-price"
				name="price"> <input type="submit" value="Update Product">
		</form>
	</div>
	...
	<form:form modelAttribute="product" action="new-product" method="POST">
